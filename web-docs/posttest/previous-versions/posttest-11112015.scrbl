...
patient: their name, height (in meters), weight (in kilograms), and last recorded heart rate 
(as beats-per-minute). A doctor's office maintains a list of the 
personal health records of all its patients.
...
@centered{@pyin{BMI = weight / height ^ 2}}
...
personal health records (from the previous problem) and produces a report containing a list of 
names (not the entire records) of patients in each BMI classification category. Use the 
